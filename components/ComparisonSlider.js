      ...
      <View>
        <ImageBackground
          ...
          {this.props.thumbnailRender && this.props.thumbnailWidth ? (
            <View
              style={{
                position: 'absolute',
                left:
                  this.state.value * this.state.imgWidth -
                  this.props.thumbnailWidth / 2,
              }}>
          ...
          <Slider
            ...
            onSlidingStart={() =>
              this.props.onSlidingStart && this.props.onSlidingStart()
            }
            onSlidingComplete={() =>
              this.props.onSlidingComplete && this.props.onSlidingComplete()
            }
